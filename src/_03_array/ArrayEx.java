...
//        System.out.println(temp[2]); // NullPointerException 에러발생 구문

        int[] intArray = {16, 22, 34, 41, 59};
        System.out.println(intArray); // [I@36baf30c : 참조주소값 출력됨
        intArray[1] = 77; // 인덱스 1번 값 변경

        // 배열 변수의 선언과 대입 시점이 다르면,
        ...
        // doubleArray.length =5 ; -> length 필드는 읽기 전용,, 수정이 불가능함
        ...
        System.out.println(langs[1] == langs[2]);

        ///////////////////////////////////////////////////////////////////////
        // 배열 관련 메소드
        // 배열 복사
        // - 표준 배열은 크기가 고정 -> 더 많은 저장 공간이 필요하면, 더 큰 길이의 배열을 새로 만들어 기존 배열 복사
